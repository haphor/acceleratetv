        ...
        if(!empty($wpvs_video_memberships_current_version)) {
            ...
            if($wpvs_video_memberships_update_version < 335) {
                ...
                function wpvs_video_memberships_update_message_335() {
                  ...
                  _e( 'IMPORTANT: WP Video Memberships needs an update. Please <a href="'.admin_url('plugins.php').'">upgrade to version 3.3.5</a>', 'vimeo-sync-memberships' );
                  echo '</div>';
                }
            }
            if($wpvs_video_memberships_update_version < 415) {
                ...
                function wpvs_video_memberships_update_message_415() {
                  echo '<div class="update-nag">';
                  _e( 'IMPORTANT: WP Video Memberships needs an update. Please <a href="'.admin_url('plugins.php').'">upgrade to version 4.1.5</a>', 'vimeo-sync-memberships' );
                  echo '</div>';
                }
            }
        }

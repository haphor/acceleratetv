<?php
// CUSTOM MENU OUTPUT
class mobile_arrow_walker extends Walker_Nav_Menu
{
...
class desktop_arrow_walker extends Walker_Nav_Menu
{
    function end_el(&$output, $item, $depth = 0, $args = array())
    {
        global $wp_query;
...
class Rogue_Comments extends Walker_Comment {
    ...
    function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
        ...
        <div <?php comment_class( $parent_class ); ?> id="comment-<?php comment_ID() ?>">
            ...
            <div id="comment-content-<?php comment_ID(); ?>" class="comment-content">
                ...
                <em class="comment-awaiting-moderation"><?php _e('Your comment is awaiting moderation', 'vs-netflix'); ?>.</em>
                <?php else:
                    comment_text(); ?>
                <?php endif; ?>
            </div><!-- /.comment-content -->
...
class WPVS_Review_Comments extends Walker_Comment {
    ...
    function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
        ...
        <div <?php comment_class( $parent_class ); ?> id="comment-<?php comment_ID() ?>">
            ...
            <div id="comment-content-<?php comment_ID(); ?>" class="comment-content">
                <?php if( !$comment->comment_approved ) : ?>
                <em class="comment-awaiting-moderation"><?php _e('Your review is awaiting moderation', 'vs-netflix'); ?>.</em>
                <?php else: 

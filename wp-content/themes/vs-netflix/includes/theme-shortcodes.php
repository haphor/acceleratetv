    ...
    <div class="vimeosync">
        ...
        <?php if(wpvs_this_theme_is_active()) { ?>
            <div class="net-theme-settings">
                <h1><?php _e('VS Netflix Shortcodes', 'vs-netflix'); ?></h1>
                ...
                <div class="vs-shortcode">
                    ...
                    <h4><?php _e('Optional Settings', 'vs-netflix'); ?></h4>
                ...
                <div class="vs-shortcode">
                    ...
                    <p><a href="<?php echo admin_url('edit-tags.php?taxonomy=rvs_video_category&post_type=rvs_video'); ?>"><?php _e('My Genres Shortcodes', 'vs-netflix'); ?></a></p>
                </div>

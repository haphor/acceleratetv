...
<div class="wrap">
    <?php include(WPVS_THEME_BASE_DIR.'/includes/admin-menu.php'); ?>
    <div class="vimeosync">
        <div class="rvsPadding">
            <h1 class="rvs-title">VS Netflix Updates</h1>
            <p>This page will display any updates and version information for the VS Netflix Theme</p>
